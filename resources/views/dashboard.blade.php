...
<!-- <a class="navbar-brand text-light" href="#">{{UserId()}}</a> -->
...
<strong class="text-info">{{$notification->data['byUser']}}</strong>
<div>
<a href="{{route('post.showNotification', $notification->data['post_id'])}}">{{$notification->data['title']}}</a>
</div>
